...
use App\Http\Controllers\Configuracion\AccionDisponibilidadController;
use App\Http\Controllers\Configuracion\AccionSistemaController;
use App\Http\Controllers\Area\AreaController;
use App\Http\Controllers\Area\AreaNivelController;
use App\Http\Controllers\Area\AreaNivelGradoController;
use App\Http\Controllers\Area\AreaOlimpiadaController;
use App\Http\Controllers\Sistema\BroadcastController;
use App\Http\Controllers\Competencia\CompetenciaController;
use App\Http\Controllers\Competidor\CompetidorController;
use App\Http\Controllers\Configuracion\ConfiguracionAccionController;
use App\Http\Controllers\Fase\CronogramaFaseController;
use App\Http\Controllers\Catalogo\DepartamentoController;
use App\Http\Controllers\Evaluacion\DescalificacionController;
...
use App\Http\Controllers\Fase\FaseGlobalController;
use App\Http\Controllers\Catalogo\GradoEscolaridadController;
use App\Http\Controllers\Competidor\ImportarcsvController;
use App\Http\Controllers\Catalogo\InstitucionController;
use App\Http\Controllers\Responsable\ListaResponsableAreaController;
use App\Http\Controllers\Catalogo\MedalleroController;
use App\Http\Controllers\Catalogo\NivelController;
use App\Http\Controllers\Olimpiada\OlimpiadaController;
use App\Http\Controllers\Catalogo\ParametroController;
use App\Http\Controllers\Reporte\ReporteController;
use App\Http\Controllers\Responsable\ResponsableController;
use App\Http\Controllers\Configuracion\RolAccionController;
use App\Http\Controllers\Sistema\SistemaEstadoController;
use App\Http\Controllers\Configuracion\UsuarioAccionesController;
