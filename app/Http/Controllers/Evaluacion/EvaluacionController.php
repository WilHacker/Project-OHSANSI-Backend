...
class EvaluacionController extends Controller
{
    ...
    public function bloquear(BloquearFichaRequest $request, int $id): JsonResponse
    {
        ...
        return response()->json(['mensaje' => 'Ficha bloqueada.', 'datos' => new EvaluacionResource($evaluacion)]);
    }
    ...
    public function guardarNota(GuardarNotaRequest $request, int $id): JsonResponse
    {
        ...
        return response()->json(['mensaje' => 'Calificación guardada.', 'datos' => new EvaluacionResource($evaluacion)]);
    }
